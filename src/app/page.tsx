...
import { ArrowUpRight, ArrowDownLeft, Wallet, Building2, TrendingUp, AlertCircle } from "lucide-react";

export default function DashboardPage() {
  // Demo financial overview numbers for initial render
  const receivablesBDT = 145000.0;
  const payablesBDT = 38500.0;
  const netCashFlowBDT = 106500.0;
  const bankBalanceBDT = 520000.0;
